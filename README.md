...
> 검색, 정렬, 필터링, 최근 검색어, 즐겨찾기를 구현하며 원하는 정보를 더 빠르게 찾는 탐색 흐름을 실험한 React + TypeScript 프로젝트
...
검색어 하이라이팅, 디바운스 처리, 정렬, 필터링, 최근 검색어, 즐겨찾기 기능을 직접 구현하며 검색 결과 화면을 구성하는 요소들을 실험하고 정리했습니다.
